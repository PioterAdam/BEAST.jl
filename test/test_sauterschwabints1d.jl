...
mrw_strategy_0 = BEAST.SauterSchwabQuadrature1d.CommonEdge(BEAST.SauterSchwabQuadrature1d._JoshuasRules(10,T(0.0),T(1.0)) )
...
mrw_strategy_1 = BEAST.SauterSchwabQuadrature1d.CommonEdge(BEAST.SauterSchwabQuadrature1d._JoshuasRules(10,T(0.0),T(1.0)) )
...
mrw_strategy_0 = BEAST.SauterSchwabQuadrature1d.CommonVertex(BEAST.SauterSchwabQuadrature1d._JoshuasRules(10,T(0.0),T(1.0)) )
...
mrw_strategy_1 = BEAST.SauterSchwabQuadrature1d.CommonVertex(BEAST.SauterSchwabQuadrature1d._JoshuasRules(10,T(0.0),T(1.0)) )
