println("RUNNING FILE: pp_test_beyn_dense_and_aca_efie_tm.jl")
...
function test_circle_cavity_Dirichlet_Beyn_ACA_circle(;
        radius::Float64 = 1.0,
        Nel::Int = 512,
        minvalues::Int = 100,
        tol::Float64 = 1e-4,
...
function test_circle_cavity_Dirichlet_Beyn_ACA_ellipse(;
        radius::Float64 = 1.0,
        Nel::Int = 512,
        minvalues::Int = 100,
        tol::Float64 = 1e-4,
...
println("\n================ ACA RUN (circle) ================\n")
λa1, Va1, oka1 = test_circle_cavity_Dirichlet_Beyn_ACA_circle(
    radius = 1.0,
    Nel = 512,
    minvalues = 100,
    tol = 1e-4,
...
println("\n================ ACA RUN (ellipse) ================\n")
λa2, Va2, oka2 = test_circle_cavity_Dirichlet_Beyn_ACA_ellipse(
    radius = 1.0,
    Nel = 512,
    minvalues = 100,
    tol = 1e-4,
