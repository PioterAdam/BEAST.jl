...
println("RUNNING FILE: pp_test_acs_vs_dense_for_nep_songle_layer_eife_tm.jl")
...
λd, Vd, okd = test_circle_cavity_Dirichlet_Beyn_ACA(
    radius = 1.0,
    Nel = 512,
    minvalues = 100,
    tol = 1e-4,
...
# # ===========================================================
# function contour_preflight_aca(ctx::CircleEFIECtx;
#                                z0::ComplexF64,
#                                Rx::Float64,
#                                Ry::Float64,
#                                N::Int = 12,
...
# λa, Va, oka = BeynSolve_auto(z0, Rx, Ry, UserFun, ApplyT, D;
#     L = 8,
#     N = 12,
#     Kmax = 2,
#     tol_svd = 1e-8,
...
# z0 = ComplexF64(2.4023180870037675, 0.001579126610271251)
# Rx = 0.008
# Ry = 0.004


# λb, Vb, okb = BeynSolve_auto(z0, Rx, Ry, UserFun, ApplyT, D;
#     L = 4,
#     N = 8,
#     Kmax = 2,
#     tol_svd = 1e-8,
...
# z0 = ComplexF64(2.4044608724587144, 0.00030405264803765454)
# Rx = 0.002
# Ry = 0.001


# λc, Vc, okc = BeynSolve_auto(z0, Rx, Ry, UserFun, ApplyT, D;
#     L = 2,
#     N = 8,
#     Kmax = 2,
#     tol_svd = 1e-8,
...
# ok_pre, zbad = contour_preflight_aca(ctx;
#     z0 = z0,
#     Rx = Rx,
#     Ry = Ry,
#     N  = 12,
...
#     kbad = ComplexF64(2.4500812255967848, 0.01)
#     kbad_conj = ComplexF64(2.4500812255967848, -0.01)


#     Sd_bad = build_dense_S(ctx, kbad;
#     quadstrat = BEAST.DoubleNumSauterQstrat(10,10,0,4,15,15))

# Sf_bad = build_fmm_S(ctx, kbad;
#     tol = 1e-4,
#     η = 0.25,
#     scheduler = SerialScheduler(),
#     nearquadstrat = BEAST.DoubleNumSauterQstrat(6,7,0,4,8,9),
...
# Sf_bad_conj = build_fmm_S(ctx, kbad_conj;
#     tol = 1e-4,
#     η = 0.25,
#     scheduler = SerialScheduler(),
#     nearquadstrat = BEAST.DoubleNumSauterQstrat(6,7,0,4,8,9),
